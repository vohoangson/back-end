...
public class JobApplication {
	...
	public JobApplication(BigInteger id, UUID uid, Job job, Candidate candidate, Translator translator,
			...
			Conversation allConversation, Timestamp applicationSucceedAt, String cancelReason, int userCancel,
			Timestamp cancelAt, int status, Timestamp createdAt, Timestamp updatedAt, Timestamp deletedAt) {
		this.id = id;
		this.uid = uid;
		this.job = job;
		this.candidate = candidate;
	...
	public JobApplication(UUID uid) {
		this.uid = uid;
	}
